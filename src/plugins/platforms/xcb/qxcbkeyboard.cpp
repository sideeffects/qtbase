...
void QXcbKeyboard::updateKeymap()
{
    ...
    bool sync_xkbStateNoModifiers = false;
	...
	// xkb_x11_state_new_from_device() call.
        ...
        if (m_xkbKeymap)
        {
            ...
            // Cannot sync m_sidefx_xkbStateNoModifiers from m_xkbState until
	    // we've updated m_sidefx_noModifiersXKBModMask, which isn't done
	    // until later in this method.
            sync_xkbStateNoModifiers = true;
        }
    } else {
